  ...
  return (
    <main className="flex-1 py-3 px-1 sm:py-4 sm:px-1.5 lg:py-6 lg:px-2 overflow-auto">
      <div className="max-w-[1800px] mx-auto space-y-4 sm:space-y-6">
        {/* Summary Cards */}
        <section aria-label="Basket summary">
          <BasketSummaryCards />
        </section>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          <section aria-label="Basket size distribution">
            <BasketDistributionChart />
          </section>
          <section aria-label="Category combinations">
            <CategoryCombosChart />
          </section>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-6">
          <section aria-label="Brand affinity">
            <BrandAffinityChart />
          </section>
          <section aria-label="Product momentum">
