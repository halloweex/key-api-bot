...
Админские эндпоинты вкладки (перепарсинг UTM, перестройка Gold) пишут DuckDB и
флагом не затронуты; их результат доезжает до Postgres следующим тиком Silver.
