...
class TestTheTableIsWhereItsMeaningPutsIt:
    ...
    def test_the_application_refuses_a_database_without_it(self):
        ...
        The pin moves with the head migration — 0027 since the two forensic
        logs landed — and this assertion is the speed bump that makes the move
        ...
        assert pg.REQUIRED_REVISION == "0027_forensics"
