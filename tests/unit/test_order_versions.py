...
class TestTheTableIsWhereItsMeaningPutsIt:
    ...
    def test_the_application_refuses_a_database_without_it(self):
        ...
        The pin moves with the head migration — 0028 since the data-quality
        journal landed — and this assertion is the speed bump that makes the
        ...
        assert pg.REQUIRED_REVISION == "0028_quality_journal"
