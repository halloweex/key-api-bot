...
class TestTheTableIsWhereItsMeaningPutsIt:
    ...
    def test_the_application_refuses_a_database_without_it(self):
        ...
        The pin moves with the head migration — 0026 since the three watchdog
        sample tables and the two send ledgers landed — and this assertion is
        ...
        assert pg.REQUIRED_REVISION == "0026_watchdogs_and_ledgers"
